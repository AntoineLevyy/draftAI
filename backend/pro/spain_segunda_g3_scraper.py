#!/usr/bin/env python3
"""
Segunda Federacion Grupo 3 (Spain 4th Tier) Player Data Scraper using Transfermarkt API
"""
...
class SpainSegundaG3APIScraper:
    def __init__(self):
        self.api_key = "3239a3729emsha33e79a3ad07beep1b4d22jsn57e37ca1df6f"
        self.host = "transfermarkt6.p.rapidapi.com"
        self.season_id = "2024"
        
        # Segunda Federacion Grupo 3 configuration
        self.league_config = {
            "id": "E4G3",
            "name": "Segunda Federacion Grupo 3",
            "short_name": "Segunda G3"
        }
    ...
    def scrape_spain_segunda_g3_players(self, include_detailed_stats: bool = True) -> list:
...
def main():
    scraper = SpainSegundaG3APIScraper()
    data = scraper.scrape_spain_segunda_g3_players()
    scraper.save(data, "backend/pro/spain_segunda_g3_players_api.json")
    print(f"Total players in Segunda Federacion Grupo 3: {len(data)}")
    print("Segunda Federacion Grupo 3 scraping completed!")
